...
class ModuleInfoWriter : Opcodes {
    ...
    fun dump(serviceMap: HashMap<String, String>, viewMap: HashMap<String, String>, fragmentMap: HashMap<String,
        ...
        cw.visit(Opcodes.V1_7, Opcodes.ACC_PUBLIC + Opcodes.ACC_SUPER, "com/dryseed/dscomponent/api/DefaultModuleIndex", null, "java/lang/Object",
            arrayOf("com/dryseed/dscomponent/api/IModule"))
        ...
        run {
            ...
            val l1 = Label()
            mv.visitLabel(l1)
            mv.visitLocalVariable("this", "Lcom/dryseed/dscomponent/api/DefaultModuleIndex;", null, l0, l1, 0)
            mv.visitMaxs(1, 1)
            mv.visitEnd()
        }
        run {
            ...
            mv.visitFieldInsn(Opcodes.GETSTATIC, "com/dryseed/dscomponent/api/DefaultModuleIndex", "viewMap", "Ljava/util/HashMap;")
            mv.visitInsn(Opcodes.DUP)
            val l1 = Label()
            mv.visitJumpInsn(Opcodes.IFNONNULL, l1)
            mv.visitInsn(Opcodes.ICONST_0)
            mv.visitMethodInsn(Opcodes.INVOKESTATIC, "com/dryseed/dscomponent/api/DefaultModuleIndex", "$$\$reportNull$$$0", "(I)V",
                false)
            mv.visitLabel(l1)
            ...
            val l2 = Label()
            mv.visitLabel(l2)
            mv.visitLocalVariable("this", "Lcom/dryseed/dscomponent/api/DefaultModuleIndex;", null, l0, l2, 0)
            mv.visitMaxs(2, 1)
            mv.visitEnd()
        }
        run {
            ...
            mv.visitLabel(l0)
            mv.visitLineNumber(16, l0)
            mv.visitFieldInsn(Opcodes.GETSTATIC, "com/dryseed/dscomponent/api/DefaultModuleIndex", "fragmentMap", "Ljava/util/HashMap;")
            mv.visitInsn(Opcodes.DUP)
            val l1 = Label()
            mv.visitJumpInsn(Opcodes.IFNONNULL, l1)
            mv.visitInsn(Opcodes.ICONST_0)
        ...
        run {
            ...
            mv.visitFieldInsn(Opcodes.GETSTATIC, "com/dryseed/dscomponent/api/DefaultModuleIndex", "serviceMap", "Ljava/util/HashMap;")
            mv.visitInsn(Opcodes.DUP)
            val l1 = Label()
            mv.visitJumpInsn(Opcodes.IFNONNULL, l1)
        ...
        run {
            ...
            mv.visitFieldInsn(Opcodes.PUTSTATIC, "com/dryseed/dscomponent/api/DefaultModuleIndex", "serviceMap", "Ljava/util/HashMap;")
            val l1 = Label()
            mv.visitLabel(l1)
            ...
            mv.visitInsn(Opcodes.DUP)
            mv.visitMethodInsn(Opcodes.INVOKESPECIAL, "java/util/HashMap", "<init>", "()V", false)
            mv.visitFieldInsn(Opcodes.PUTSTATIC, "com/dryseed/dscomponent/api/DefaultModuleIndex", "viewMap", "Ljava/util/HashMap;")
            val l2 = Label()
            mv.visitLabel(l2)
            ...
            mv.visitInsn(Opcodes.DUP)
            mv.visitMethodInsn(Opcodes.INVOKESPECIAL, "java/util/HashMap", "<init>", "()V", false)
            mv.visitFieldInsn(Opcodes.PUTSTATIC, "com/dryseed/dscomponent/api/DefaultModuleIndex", "fragmentMap",
                "Ljava/util/HashMap;")
            var i = 26
            for (key in serviceMap.keys) {
                ...
                mv.visitFieldInsn(Opcodes.GETSTATIC, "com/dryseed/dscomponent/api/DefaultModuleIndex", "serviceMap",
                    "Ljava/util/HashMap;")
                mv.visitLdcInsn(key)
            ...
            for (key in fragmentMap.keys) {
                ...
                mv.visitFieldInsn(Opcodes.GETSTATIC, "com/dryseed/dscomponent/api/DefaultModuleIndex", "fragmentMap",
                    "Ljava/util/HashMap;")
                mv.visitLdcInsn(key)
                mv.visitLdcInsn(Type.getType("L$value;"))
                mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/util/HashMap", "put",
        ...
        run {
            ...
            mv.visitInsn(Opcodes.DUP)
            mv.visitInsn(Opcodes.ICONST_0)
            mv.visitLdcInsn("com/dryseed/dscomponent/api/DefaultModuleIndex")
